...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { deadline: @pin.deadline, description: @pin.description, price: @pin.price }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { deadline: @pin.deadline, description: @pin.description, price: @pin.price }
    assert_redirected_to pin_path(assigns(:pin))
  end
